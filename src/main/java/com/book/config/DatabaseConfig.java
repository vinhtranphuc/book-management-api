...
import com.book.interceptor.MyBatisQueryIntercept;
import com.book.interceptor.MyBatisUpdateIntercept;
...
@MapperScan(basePackages = "com.book.mybatis.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.book.jpa.entity" });
    ...
    public DataSource dataSource() {
    	...
    	dataSource.setUrl("jdbc:mysql://123.108.176.25:3306/book?createDatabaseIfNotExist=true&useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&zeroDateTimeBehavior=convertToNull");
        dataSource.setUsername("NHLINE");
        dataSource.setPassword("voice!!11");
        return dataSource;
    }
    ...
    public SqlSessionFactory sqlSessionFactory(ApplicationContext applicationContext) throws Exception {
        ...
        registTypeAlias("com.book.mybatis.model", FieldMap.class);
