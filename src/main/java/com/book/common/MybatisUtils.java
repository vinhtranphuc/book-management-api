...
public class MybatisUtils {
	...
	/**
	 * parameter null ex. <if test="@com.book.common.MybatisUtils@isEmpty(parameter)">
	 */
	...
	/**
	 * parameter not null ex. <if test="@com.book.common.MybatisUtils@isNotEmpty(parameter)">
	 */
	...
	/**
	 * parameter is collection and not null ex. <if test="@com.book.common.MybatisUtils@isExistCollection(parameter)">
	 */
	@SuppressWarnings("rawtypes")
	...
	/**
	 * parameter is collection and not null ex. <if test="@com.book.common.MybatisUtils@isValidDate(...parameter)">
	 */
	...
	/**
	 * parameter is collection and not null ex. <if test="@com.book.common.MybatisUtils@isInteger(parameter)">
	 */
